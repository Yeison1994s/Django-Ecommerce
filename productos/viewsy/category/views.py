...
from productos.forms import CategoryForm
from productos.models import Category

class CategoryListView(ListView):
    model = Category
    template_name = 'productos/category/list.html'
...
class CategoryCreateView(CreateView):
    ...
    template_name = 'productos/category/create.html'
...
class CategoryDeleteView(DeleteView):
    model = Category
    template_name = 'productos/category/delete.html'
    success_url = reverse_lazy('category_list')
